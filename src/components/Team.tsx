...
const Team = () => (
  <div className="mb-2 bg-base-200 p-8 shadow-lg text-neutral-content rounded-box">
...
const BetterPerson = ({ name, role }) => (
  <div className="card items-center p-8 transition-colors duration-200 transform cursor-pointer group hover:bg-secondary bg-base-100 shadow-xl">
    ...
    <h1 className="mt-4 text-2xl font-semibold  capitalize  group-hover:text-secondary-content">
      {name}
    </h1>

    <p className="mt-2 text-secondary capitalize group-hover:text-secondary-content">
      {role}
    </p>

    <div className="flex mt-3 -mx-2 group-hover:text-secondary-content">
  ...
  <section className="bg-base-200 rounded-xl">
    <div className="container px-6 py-10 mx-auto">
      ...
      <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-3">
        <BetterPerson name="Amin Debabeche" role="Product Manger " />
        <BetterPerson name="Lucas Giordano" role="Full stack developer" />
        <BetterPerson name="Augustin Kapps" role="Protocol" />
      </div>
    </div>
  </section>
);

export default BetterTeam;
